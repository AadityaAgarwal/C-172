...
AFRAME.registerComponent("markerhandler", {
  ...
  handleOrderSummary: async function () {
    ...
    td_1.setAttribute('class', 'no-line')
    td_2.setAttribute('class', 'no-line')
    td_3.setAttribute('class', 'no-line text-center')
    var strong_tag = document.createElement('strong')
    strong_tag.innerHTML = 'Total'
    td_3.appendChild(strong_tag)

    td_4.setAttribute('class', 'no-line text-right')
    td_4.innerHTML = '$' + orderSummary.total_bill

    total_tr.appendChild(td_1)
    total_tr.appendChild(td_2)
    total_tr.appendChild(td_3)
    total_tr.appendChild(td_4)
